...
let Terminos = `
*_Toda la información que se mencione aquí no excluye a el Propietario del Bot, y Propietarios Acredores al uso de PapolitoBot_*
...
_- El chat anónimo del comando #start, valga la redundancia no mostrará ningún dato de los Usuarios por parte de PapolitoBot. Eso no implica que las personas que hagan uso de esta función puedan dar a conocer sus datos. en Número(s) Oficial(es)._

_- Los Datos que Obtenga PapolitoBot en Cuentas Oficiales de Usuarios(as), Grupos y Ajustes del Mismo puede verse Reiniciado, Modificado, y/o Retificado con el fin de que el Bot este en Óptimas Condiciones para su Uso. (Usuarios(as) Pueden Pedir Compensación Por Instagram o por el comando #Reporte. Debe de Presentar Pruebas)._
...
_- Al hacer uso de ciertos comandos que tengan como objetivo socavar la incomodidad, intranquilidad, molestia u otro termino tajante, se tomarán las respectivas sanciones o llamados de alerta para prevalecer la integridad de los/las Usuarios(as) y funcionamiento de PapolitoBot._


*ESTE ES EL REPOSITORIO OFICIAL*
*https://github.com/PapolitoNina-Li/PapolitoBot-MD*


*CUENTA OFICIAL DE ASISTENCIA - INSTAGRAM*
~ _Solo en esta Cuenta Respondo si tiene Dudas, Preguntas o Necesita Ayuda sobre PapolitoBot, También puede Comunicarse en Caso de Temas de Colaboración_
*https://www.instagram.com/Papolito_dios*
...
*~ Muchas Gracias Por tomarte el tiempo en informate sobre PapolitoBot*
`.trim()
conn.sendHydrated(m.chat, Terminos,  `${wm}\nEstamos de acuerdo en Hacer Colaboraciones con Personas Comprometidas, manteniendo el Respeto Puedes Contactar si ese es el caso a esta Cuenta Oficial | https://www.instagram.com/Papolito_dios`, pp, 'https://github.com/PapolitoNina-Li/PapolitoBot-MD', '𝙂𝙖𝙩𝙖𝘽𝙤𝙩-𝙈𝘿', null, null, [
